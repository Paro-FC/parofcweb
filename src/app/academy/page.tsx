      ...
      <div className="container mx-auto px-4 py-10 md:py-14">
        ...
        {Array.isArray(academy?.intro) && academy!.intro!.length > 0 ? (
          <div className="prose prose-lg max-w-none">
            <PortableText
              value={academy!.intro!.filter(Boolean) as any}
          ...
          <div className="space-y-4 text-base md:text-lg text-gray-700 leading-relaxed">
            ...
            <p>
              From grassroots beginnings to elite youth competition, every
              player at Paro FC is guided through a structured football journey
              built on discipline, learning, and excellence.
            </p>
